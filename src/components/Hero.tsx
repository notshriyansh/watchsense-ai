...
const Hero = ({ movie, reason }: Props) => {
  ...
  return (
    <section className="relative w-full min-h-[80vh] flex items-center">
      ...
      />
      <div className="absolute inset-0 bg-linear-to-r from-[#0B0F14] via-[#0B0F14]/90 to-transparent" />
      <div className="absolute inset-0 bg-linear-to-t from-[#0B0F14] via-transparent to-transparent" />
      ...
      <div className="relative z-10 max-w-3xl px-6 sm:px-12 mt-16">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs text-[#8A93A3] tracking-widest uppercase font-medium">
            Selected For You
          </span>
        </div>
        ...
        {reason && (
          <div className="bg-[#0E1622] border-l-2 border-cyan-500 p-5 rounded-r-md mb-8 max-w-xl shadow-xl">
            ...
            <p className="text-sm text-[#E6EAF0] leading-relaxed">{reason}</p>
          </div>
        )}
